...
public class DirtyableEnhancer<T> extends VelocityEnhancer<T> {

    //-------------------------------------------------------------
    // Constructor
    //-------------------------------------------------------------

    public DirtyableEnhancer(Class<T> baseClass) {
        super(baseClass);
    }
    ...
    protected String getTemplateLocation() {
        return "org/jeppetto/dao/mongodb/enhance/dirtyable.vm";
    }
}
