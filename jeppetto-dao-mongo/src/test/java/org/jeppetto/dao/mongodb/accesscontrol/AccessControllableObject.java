...
package org.jeppetto.dao.mongodb.accesscontrol;
...
public class AccessControllableObject {
    ...
    public AccessControllableObject() {
    }


    public AccessControllableObject(int intValue) {
