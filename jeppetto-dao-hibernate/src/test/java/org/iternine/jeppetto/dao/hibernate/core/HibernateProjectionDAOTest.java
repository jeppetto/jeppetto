...
public class HibernateProjectionDAOTest extends ProjectionDAOTest {
    ...
    protected ProjectionDAO getProjectionDAO() {
        if (testContext == null) {
            testContext = new TestContext("HibernateProjectionDAOTest.spring.xml",
                                          "HibernateDAOTest.test.properties",
                                          "hibernateDAOTest.jdbc.driverClass");

        }

        return (ProjectionDAO) testContext.getBean("hibernateProjectionDAO");
    }
